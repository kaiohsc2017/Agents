...
from routers import agents, servers, executions, reports, knowledge, flows, audio_qos
...
app.include_router(audio_qos.router,  prefix="/api/audio-qos",  tags=["audio-qos"])
