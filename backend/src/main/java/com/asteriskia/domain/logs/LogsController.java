...
public class LogsController {
    ...
    // Containers reais do stack AgentIA (deve casar com _ALLOWED_SERVICES do docker-helper).
        ...
        try {
            ...
            String ts =
                    DateTimeFormatter.ofPattern("yyyyMMdd-HHmmss")
                            ...
                            .format(Instant.now());
            StringBuilder sb =
                    new StringBuilder("# AgentIA — Asterisk Log\n# " + Instant.now() + "\n\n");
    ...
    private List<String> resolveServices(String param) {
        ...
        for (String s : param.split(",")) {
            String t = s.trim();
            r.add(t.startsWith("agentia-") ? t : "agentia-" + t);
        }
        return r;
    }
}
