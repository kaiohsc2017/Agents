...
class AuthControllerTest {
    ...
    void refresh_usuarioDesativadoOuRemovido_naoDeveGanharPermissoesDeAdmin() throws Exception {
        ...
        when(userRepo.findByUsernameIgnoreCaseAndIsActiveTrue(username)).thenReturn(Optional.empty());
    ...
    void login_usuarioNaoLocal_bindAdOk_deveProvisionarNovoUsuario() throws Exception {
        ...
        when(userRepo.findByUsernameIgnoreCaseAndIsActiveTrue("novo.ad")).thenReturn(Optional.empty());
        ...
        when(userRepo.findByUsernameIgnoreCase("novo.ad")).thenReturn(Optional.empty());
