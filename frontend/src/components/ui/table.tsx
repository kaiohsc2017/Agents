...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-muted/40 text-muted-foreground font-semibold uppercase text-[10px] tracking-wider border-b border-border/60", className)} {...props} />
))
