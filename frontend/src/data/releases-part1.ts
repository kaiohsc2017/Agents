// Changelog estático do sistema — parte 1 (v1 a v1.44), extraída de releases.ts
// para respeitar o limite de 800 linhas por arquivo. Ver releases.ts (agregador)
// e Release.tsx (consumidor).

import type { ReleaseEntry } from './releases';

export const RELEASES_PART1: ReleaseEntry[] = [
  {
    version: 'v1',
    date: '2026-07-04',
    changes: [
